...
CardObject::CardObject(string id, re::RedruEngine& engine, sf::Texture& frontTexture, sf::Texture& backTexture, int group) :
	GameObject(id),
	engine(engine),
...
void CardObject::onInput(sf::Event& event) {
	if (event.type == sf::Event::MouseButtonReleased
		...
		re::GameEvent event("CARD_FLIPPED");
...
void CardObject::onEvent(re::GameEvent& event) { }
